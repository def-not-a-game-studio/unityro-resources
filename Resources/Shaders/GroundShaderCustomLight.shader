Shader "UnityRO/GroundShaderCustomLight"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes IN)
            {
                ...
                OUT.normal = GetVertexNormalInputs(IN.normal).normalWS;
                OUT.color = IN.color;
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                float3 vertexSH;
                OUTPUT_SH(IN.normal, vertexSH);
                // This function calculates the final baked lighting from light maps or probes
                float3 diff = SAMPLE_GI(lightmapUV, vertexSH, IN.normal);
